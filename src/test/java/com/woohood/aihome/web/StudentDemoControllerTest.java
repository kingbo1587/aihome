...
public class StudentDemoControllerTest {
	...
	public void testGetById() throws Exception {
		MockHttpServletRequestBuilder requestBuilder = MockMvcRequestBuilders.get("/studentDemo/getById");
	...
	public void testGetByIdPost() throws Exception {
		MockHttpServletRequestBuilder requestBuilder = MockMvcRequestBuilders.post("/studentDemo/getById");
		requestBuilder.param("id", "1");
		mockMvc.perform(requestBuilder).andExpect(MockMvcResultMatchers.status().isOk()).andDo(MockMvcResultHandlers.print());
	}
